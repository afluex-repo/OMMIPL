(function ($) {
    ...
    if($sliderActvation.length > 0){
        $sliderActvation.slick({
          prevArrow:'<button class="prev_arrow"><img width="17" height="24" src="../assets/img/icon/navigation-arrow2.jpg" alt=""></button>',
          nextArrow: '<button class="next_arrow"><img width="17" height="24" src="../assets/img/icon/navigation-arrow1.jpg" alt=""></button>',
        });
    };
