...
namespace OMMIPL.Models
{
    public class DBHelper
    {
        ...
        static DBHelper()
        {
            try
            {
                connectionString = "Data Source=103.48.51.111,1232;Initial Catalog=OMMIPLDb;User Id=OMMIPLUser;Password=ommipl123!@#;Integrated Security=false;";

                //connectionString = "Data Source=103.48.51.111,1232;Initial Catalog=dostdbtest;User Id=dostuser;Password=Pa$$w0rd@123;Integrated Security=false;";
            }
            catch (Exception)
            {
                throw;
